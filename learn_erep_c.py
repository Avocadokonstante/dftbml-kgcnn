...
def make_model_c():
    ...
    gamma_per_bond_conv = GraphSageNodeLayer(units=1, use_edge_features=False)([gamma_per_bond, pair_index_input])

    erep_per_bond = ErepForLab(add_eps=False)([charges_per_bond, distance_input, gamma_per_bond_conv])
